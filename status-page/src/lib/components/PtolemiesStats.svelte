	...
	<div class="card-body">
		...
		<div class="stats stats-vertical lg:stats-horizontal shadow bg-black mb-4">
			<div class="stat">
				...
				<div class="stat-title text-white">Total Chunks</div>
				<div class="stat-value text-white">{totalChunks}</div>
				<div class="stat-desc text-white">Documentation segments</div>
			</div>
			...
			<div class="stat">
				...
				<div class="stat-title text-white">Active Sources</div>
				<div class="stat-value text-white">{totalSources}</div>
				<div class="stat-desc text-white">Framework docs</div>
			</div>
			...
			<div class="stat">
				...
				<div class="stat-title text-white">Coverage</div>
				<div class="stat-value text-white">{coverage}%</div>
				<div class="stat-desc text-white">Target achieved</div>
			</div>
			...
			<div class="stat">
				...
				<div class="stat-title text-white">Avg Quality</div>
				<div class="stat-value text-white">{avgQuality.toFixed(2)}</div>
				<div class="stat-desc text-white">Content score</div>
			</div>
		</div>
				...
				<tbody>
					{#each chunkData as { source, chunks, quality, status }}
						<tr class="hover:bg-black">
							<td class="font-medium text-white">{source}</td>
							<td>
								<div class="badge text-white">{chunks}</div>
							</td>
							<td>
								<div class="badge text-white">{quality.toFixed(2)}</div>
							</td>
							<td>
								<div class="badge text-white">✅ {status}</div>
							</td>
						</tr>
					{/each}
				</tbody>
