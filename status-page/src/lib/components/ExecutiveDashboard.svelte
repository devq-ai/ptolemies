...
<div class="hero bg-gradient-to-br from-primary to-secondary text-primary-content mb-8" data-theme="ptolemies">
		...
		<div class="w-full">
			...
			<div class="mb-6">
				...
				<div class="flex flex-wrap items-center justify-center gap-4 text-sm opacity-90">
					...
					<div class="badge {getOverallStatusBadge(systemHealth.overall_status)} badge-lg">
				...
				<div class="card bg-base-100 text-base-content shadow-lg">
					<div class="card-body">
						...
						<div class="flex items-center gap-4">
							<div class="radial-progress text-success" style="--value:{serviceHealth};" role="progressbar">
							...
							<div class="text-sm space-y-1">
								...
								<div class="flex justify-between">
									<span>Uptime:</span>
									<span class="font-bold text-success">{systemHealth.system_uptime}%</span>
								</div>
								<div class="flex justify-between">
									<span>Performance:</span>
									<span class="font-bold {systemHealth.response_time_avg < 200 ? 'text-success' : 'text-warning'}">
					...
					<div class="card-body">
						...
						<div class="space-y-3">
							<div class="flex items-center justify-between">
								...
								<div class="flex items-center gap-2">
									<progress class="progress progress-primary w-16" value={quickMetrics.knowledge_base_chunks} max="500"></progress>
							...
							<div class="flex items-center justify-between">
								...
								<div class="flex items-center gap-2">
									<progress class="progress progress-secondary w-16" value={quickMetrics.neo4j_nodes} max="100"></progress>
							...
							<div class="flex items-center justify-between">
								...
								<div class="flex items-center gap-2">
									<progress class="progress progress-accent w-16" value={quickMetrics.ai_accuracy} max="100"></progress>
							...
							<div class="flex items-center justify-between">
								...
								<div class="flex items-center gap-2">
									<progress class="progress progress-info w-16" value={quickMetrics.graph_density} max="10"></progress>
...
<style lang="postcss">
	.hero {
		background: linear-gradient(135deg, #FF10F0 0%, #9D00FF 100%);
		position: relative;
		overflow: hidden;
	}
